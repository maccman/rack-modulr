module Rack::Modulr
  module Options
    ...
    # Handles options for Rack::Modulr
    # Available options:
    # => root
    ...
    #    CommonJS files are located
    # => public
    #    the path (relative to the root) where
    #    static files are served
    # => hosted_at
    #    the public HTTP root path for javascripts
    ...
    module ClassMethods
      ...
      # Rack::Modulr uses the Rack Environment to store option values. All options
